...
class WC_Product_Documents_Widget_Documents extends WP_Widget {
	...
	public function __construct() {
		...
		$options = array(
			...
			'description' => __( 'Display a set of product documents for the current product if on a product page.', WC_Product_Documents::TEXT_DOMAIN ),
		);

		// instantiate the widget
		parent::__construct( 'wc_product_documents_widget_documents', __( 'WooCommerce Product Documents', WC_Product_Documents::TEXT_DOMAIN ), $options );
	...
	public function widget( $args, $instance ) {
		...
		global $wc_product_documents, $product;
	...
	public function form( $instance ) {
		...
		?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title', WC_Product_Documents::TEXT_DOMAIN ) ?>:</label>
