 ...
 *
 * @param string $title optional title to display above the set of documents.
 *        false indicates that the product documents element is a widget and
 *        the default WordPress widget title will be rendered.
 * @param WC_Product $product the product to render documents for
 * @param WC_Product_Documents_Collection the collection of product documents
 *
 * @version 1.0
 * @since 1.0
 */
...
if ( $title ) echo apply_filters( 'wc_product_documents_title_html', '<h3 class="woocommerce-product-documents-title">' . esc_html( $title ) . '</h3>', $title, $product );

?>
<div class="woocommerce-product-documents-<?php echo $product->id ?> woocommerce-product-documents">
